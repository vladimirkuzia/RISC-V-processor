...
HD_PWD='C:/Users/Владимир/Desktop/lab_5_aps/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log riscv_unit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source riscv_unit.tcl
