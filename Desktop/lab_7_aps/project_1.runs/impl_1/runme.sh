...
HD_PWD='C:/Users/Владимир/Desktop/lab_5_aps/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log riscv_unit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source riscv_unit.tcl -notrace
